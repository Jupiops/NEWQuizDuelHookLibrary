...
namespace Offsets {
    ...
    void Initialize() {
        ...
        Methods::QuestionContainerClassic_GetTimerDuration = findPattern("00 00 00 E3 A0 01 44 E3 1E FF 2F E1");
        Methods::VIPManager_HasVIPProperty = findPattern(
                "01 00 40 E2 01 00 50 E3 06 00 00 8A 00 48 2D E9 0D B0 A0 E1 04 00 00 EB 00 00 50 E3 00 48 BD E8 01 00 A0 13 1E FF 2F 11 2E 00 00 EA");
